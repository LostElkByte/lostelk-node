const colorNameTranslateChinese = (colorName) => {
  ...
  switch (colorName) {
    ...
    case 'chartreuse':
      ...
      break;
    case 'chocolate':
      chineseColorName = ['褐色', '巧克力色', '黄褐色', '浅棕色']
      break;
    case 'coral':
      chineseColorName = ['橘红色', '珊瑚色', '浅橘红色']
      break;
    case 'cornflowerblue':
    ...
    case 'paleturquoise':
      ...
      break;
    case 'palevioletred':
      chineseColorName = ['浅紫色', '浅紫红色']
      break;
    case 'papayawhip':
      chineseColorName = ['米色', '木瓜色']
      break;
    case 'peachpuff':
    ...
    case 'seagreen':
      ...
      break;
    case 'seashell':
      chineseColorName = ['浅粉色', '肉色', '贝壳色']
      break;
    case 'sienna':
      chineseColorName = ['深棕色', '赭色']
      break;
    case 'skyblue':
    ...
    case 'steelblue':
      ...
      break;
    case 'tan':
      chineseColorName = ['棕色', '深褐色', '黄棕色']
      break;
    case 'thistle':
      chineseColorName = ['紫色', '浅紫色', '苍紫色']
      break;
    case 'tomato':
      chineseColorName = ['鲜红色', '番茄色']
      break;
    case 'turquoise':
